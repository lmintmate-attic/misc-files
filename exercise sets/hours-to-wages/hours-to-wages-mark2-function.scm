...
;the if statement that rules off 0 and negative numbers
 (if (or (<= rate 0)(<= hours 0) (<= overtime-threshold 0)) (display "Please write a number of hours, rate and/or overtime threshold above zero.")
...
(display "Please use a number for the hours, rate and/or overtime threshold.")))
